...
class Circle extends Node {
    ...
    init(options) {
        this._feature = {
            ...
            properties: Object.assign({drawType: Node.CIRCLE}, options.properties)
        };
    ...
    async update(updateData) {
        ...
        // 更新source._data
        options.properties = Object.assign({drawType: Node.CIRCLE}, options.properties);
        ...
        if (sourceLayer) {
            ...
            sourceLayer.updateData({
                update: [{
                    ...this._feature,
                    newGeometry: {...this.geometry, type: Node.CIRCLE},
